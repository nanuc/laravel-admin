            ...
            <div class="relative flex-1 flex flex-col max-w-xs w-full bg-white">
                ...
                <div class="flex-1 h-0 pt-5 pb-4 overflow-y-auto">
                    <div class="flex-shrink-0 flex items-center px-4">
                        <img class="h-8 w-auto" src="{{ config('laravel-admin.logo') }}">
                    </div>
                ...
                <div class="flex-shrink-0 flex border-t border-gray-200 p-4">
                    <a href="#" class="flex-shrink-0 group block">
                        <div class="flex items-center">
                            <div>
                                <img class="inline-block h-10 w-10 rounded-full" src="https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?ixlib=rb-1.2.1&ixqx=OulrsJwoXW&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=facearea&facepad=2&w=256&h=256&q=80" alt="">
                            </div>
                            <div class="ml-3">
                ...
                <div class="flex-1 flex flex-col pt-5 pb-4 overflow-y-auto">
                    ...
                    <nav class="mt-5 flex-1 px-2 bg-white space-y-1">
                        @foreach(config('laravel-admin.modules') as $module)
                            <x-admin::navigation-item :module="new $module"/>
                        @endforeach
                    </nav>
                </div>
                <div class="flex-shrink-0 flex border-t border-gray-200 p-4">
